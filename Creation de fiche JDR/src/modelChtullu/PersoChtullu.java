...
public class PersoChtullu implements DataChtullu{
	...
	private int force, dexterite, intelligence, idee, constitution, apparance, pouvoir, chance, taille, sante, education, connaissance, santeMentale, pm, pv = 0;
	...
	public void initSpec2(){
		int temp1 = competenceInit[18];
		int temp2 = competenceInit[25];
