...
public class GestionMetierCht {
	...
	public ArrayList<Boolean> GestionMCht (String metier) {
		...
		if(metier.equals("Antiquaire")){
			// metier est antiquaire : Art, Droit, Bibliotheque, Histoire, Langue Etrangère, Marchandage, Trouver Objet Caché, + 1 compétence au choix
			...
			// metier est Artiste : Art, Baratin, Histoire, Photographie, Psychologie, Trouver Objet Caché, + 2 compétence au choix.
			competenceBool.remove(2);
			competenceBool.add(2, true);
			...
			// metier est Artiste de cabaret :Art, Baratin, Crédit, Ecouter, Esquiver, Langue Etrangère, Psychologie + 1 autre cométence au choix.
			competenceBool.remove(2);
			competenceBool.add(2, true);
			competenceBool.remove(5);
			competenceBool.add(5, true);
			...
			// conduire engin lourd, electricité, fusil, histoire naturelle, mecanique, premier soin, suivre une psite + 1 comp perso
			...
			//lutte, coup de poing, Histoire naturelle, occultisme, persuasion, suivre une piste, trouver ob caché + 2 comp perso
			...
			// bibliotheque, chimie, electricité, geologie, mecanique, physique + 2 comp perso
			competenceBool.remove(6);
			competenceBool.add(6, true);
			...
			//arme de poing, baratin, droit, marchandage, persuasion, psychologie, trouver ob caché + 1 comp perso
			competenceBool.remove(47);
			competenceBool.add(47, true);
			competenceBool.remove(5);
			competenceBool.add(5, true);
			...
			// arme de poing, comptabilité, credit, suivre une piste, histoire, marchandage, persuasion, psychologie
			competenceBool.remove(47);
			competenceBool.add(47, true);
			...
			//ecouter, histoire naturelle, lancer, mecanique, nager, occultisme, piloter ,Navigation, trouve ob caché
			competenceBool.remove(16);
			competenceBool.add(16, true);
			competenceBool.remove(22);
			competenceBool.add(22, true);
			...
			// bibliotheque, comptabilité, ecouter, histoire, langue etrangere, persuasion, premier soins, psychologie
			competenceBool.remove(6);
			competenceBool.add(6, true);
			competenceBool.remove(9);
			competenceBool.add(9, true);
			...
			//arme de poing, art martiaux, dissimulation, fusil, persuasion, se cacher, trouver ob caché + 1 comp perso
			competenceBool.remove(47);
			competenceBool.add(47, true);
			...
			//baratin, discretion, ecouter, histoire naturelle, marchandage, se cacher, trouve rob caché + 1 comp perso
			competenceBool.remove(5);
			competenceBool.add(5, true);
			competenceBool.remove(13);
			competenceBool.add(13, true);
	...
	private int compPerso(String arg) {
	    ...
	    nom = (String)jop.showInputDialog(null, "Veuillez Choisir votre " + arg + " competence personnelle!",
	    		"Compétence personnel, metier : " + metier,JOptionPane.QUESTION_MESSAGE,null,competence,
	    		competence[0]);
	...
	private String choixLangueEtr() {
	    ...
	    String langueEtr = etr.showInputDialog(null, "Veuillez choisir votre langue étrangère : ", "Attention", JOptionPane.QUESTION_MESSAGE);
