...
public class CreationAuto implements DataChtullu{

	private int forc, dex, inte, con, app, pou, tai, ide, san, chanc, connais, pv, pm, sm, edu, age = 0;
...
/*
 * for, con, pou, dex app = 3d6 = 3min, 18max tai, int = 2d6 + 8 = 10min, 20max
 * edu = 3d6 + 3 = 6min, 21max san = pou * 5 = 25max
 */
