...
public class EdtitionChtullu extends JFrame{
	...
	private int forc, dex, inte, prof2, ide, con, app, pou, chanc, tai, san, edu, connais, sm, pm, pv = 0;
	private int age;
	private int sx = 0;
	...
	private int anthropologie, archeologie, art, artMartiaux, astronomie,  baratin, bibliotheque, camouflage, chimie, comptabilite, conduireAuto, conduireEnginLourd, credit, discretion, dissimulation, droit, 
	ecouter, electricitee, esquiver, geologie, grimper, histoire, histoireNaturel, lancer, languesEtrangeres, langueNatale, marchandage, mecanique, medecine, monterCheval, mytheChtullu, 
	nager, navigation, occultisme, persuasion, pharmacologi, photographie, physique, piloter, permiersSoins, psychanalyse, psychologie, sauters, seCacher, serrureries, suivrePistes, trouverObjetCache,
	armePoing, fusil, fusilChasse, mitrailette, mitrailleuse, coupPied, coupPoing, coupcTete, lutte, eloquence, dessinerCarte, chanter, botanique, pickpocket, soignerEmpoisonnement, soignerMaladie;
	...
	public EdtitionChtullu(ArrayList<String> caractPerso, ArrayList compGPerso, ArrayList diversPerso) {
		...
		Icon icon = new ImageIcon(new ImageIcon("img/edit/chtulhu-1920.jpg").getImage().getScaledInstance(img.getWidth(), img.getHeight(), Image.SCALE_DEFAULT));
	...
	public String selecChemin(){
		// permet de choisir la destination et le nom de la fiche pour l'enregistrement
		...
		int resultatEnregistrer = cheminInt.showDialog(cheminInt, approve);
		 ...
		 else monFichier = monFichier + ".jpg";
	...
	public void convert() {
		...
		BufferedImage image = new BufferedImage(container2.getSize().width, container2.getSize().height,BufferedImage.TYPE_INT_ARGB);
